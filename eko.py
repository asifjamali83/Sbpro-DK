...
wait = {
    ...
    "unsend":True,
    "mention":"Hey There , you miss me , may be im not here....   ?",
    "Respontag":"Thanks auto Like by  Rango",
    "welcome":"Welcome to Faimly Group",
    "leave":"See you Again, miss you Dear",
    "comment":"  ✯❇͜͡❇͜͡C͜͡r͜͡e͜͡a͜͡t͜͡o͜͡r✯͜͡$͜͡ë͜͡I͜͡F͜͡-͜͡฿͜͜͡͡o͜͡t͜͡ ͜͡❇͜͡❇✯\nhttps://line.me/ti/p/3dctEQ_VnU\nhttps://line.me/ti/p/3dctEQ_VnU\n➣ѕєʟғвот κɪcκєʀ_+_ᴘʀᴏᴛᴇᴄᴛ\n────────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅────────",
    "message":"вστ вy:ᖇαѕ¢al's ѕqυα∂",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def help():
    ...
    key = key.title()
    helpMessage = "⚫ " + key + " [🔰🎗⚫Rango Is Back⚫🎗☯t]\n" + \
                   "⚫" + key + "✰DRAGON KILLER✰\n" + \
                  "⚫ " + key + "ʜᴇʟᴘ\n" + \
                  "⚫ " + key + "ʜᴇʟᴘ1\n" + \
                  "⚫ " + key + "ʜᴇʟᴘ2\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "⚫ " + key + " [🔰🎗⚫Rango Is Back⚫🎗☯t]\n" + \
                  "⚫ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "⚫ " + key + "ɢɪɴғᴏ\n" + \
                  "⚫ " + key + "ᴏᴘᴇɴ\n" + \
                  "⚫ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "⚫ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🔰]   ʙʏ: ᖇαѕ¢al's ѕqυα∂「🔰] \n" + \
                   "  Creator:  https://line.me/ti/p/3dctEQ_VnU"
                 ...
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        cl.sendMessage(msg.to,"Contact itu sudah To anggota bot")
                        wait["addbots"] = True
                    else:
                        Bots.append(msg.contentMetadata["mid"])
                        wait["addbots"] = True
                        cl.sendMessage(msg.to,"Promoted ke anggota bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["mid"])
                        cl.sendMessage(msg.to,"Removed From List dari anggota bot")
                    else:
                        wait["dellbots"] = True
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                    if wait["Addimage"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Promoted gambar {}".format(str(wait["Addimage"]["name"])))
               ...
               if msg.contentType == 2:
                 if msg._from in admin:
                    if wait["Addvideo"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Promoted video {}".format(str(wait["Addvideo"]["name"])))
               ...
               if msg.contentType == 7:
                 if msg._from in admin:
                    if wait["Addsticker"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Promoted sticker {}".format(str(wait["Addsticker"]["name"])))
               ...
               if msg.contentType == 3:
                 if msg._from in admin:
                    if wait["Addaudio"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Promoted mp3 {}".format(str(wait["Addaudio"]["name"])))
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     cl.sendMessage(msg.to, "Succesed mengubah foto group")
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ARfoto"]:
                            ...
                            cl.sendMessage(msg.to,"Foto Succesed dirubah")
               if msg.contentType == 2:
                   if msg._from in admin:
                       if mid in Setmain["ARvideo"]:
                            ...
                            cl.sendMessage(msg.to,"Foto Succesed dirubah To video")
...
#CLONE
                          ...
                          if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                for ls in lists:
                                    ...
                                    cl.sendMessage(to, "➧ Succesed clone profile")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  cl.sendMessage(to, "Succesed tolak sebanyak {} undangan grup".format(str(len(ginvited))))
                              else:
...
#                                ret_ += "\n╚══[ Total {} Spam call]".format(str(dan[1]))
                                cl.sendMessage(msg.to, "Succesed Sct ")
...
#===========BOT UPDATE============#
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                cl.sendMessage(msg.to,"Nama Changed To " + string + "")
#KICKALL
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "「 Status Lurking 」\nSuccesed diaktifkan, selanjutnya ketik lurkers\n\n• Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                Setmain["RAlimit"] = num
                                cl.sendText(msg.to,"「 Status Spamtag 」\nSuccesed diubah To {} kali".format(str(strnum)))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                cl.sendMessage(msg.to, "Succesed mengundang {} undangan Call Grup".format(str(wait["limit"])))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              cl.sendText(msg.to,"「 Spam Gift 」\nSuccesed spamgift {} kali".format(str(jumlah)))
                              if jumlah <= 1000:
...
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Removed From List {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                f = codecs.open("video.json","w","utf-8")
                                json.dump(videos, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Removed From List video {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                f = codecs.open("audio.json","w","utf-8")
                                json.dump(audios, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Removed From List mp3 {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Removed From List sticker {}".format( str(name.lower())))
                            else:
...
"Ⓜⓐⓗ━👿━\n"
		...
		"╚╩╝╚╝╚╝━╚╝━╚╝╚╝\n"
		"━━━━━━━━━━━━━━━\n"
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://https://line.me/ti/p/3dctEQ_VnU\nhttp://line.me/ti/p/ryansakra_m1")
                               cl.sendMessage(msg.to, None, contentMetadata={"STKID":"15996978","STKPKGID":"1416471","STKVER":"1"}, contentType=7)

                        elif cmd == ".dk-bot" or cmd == "RanGo":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[🔰 🎗⚫Rango Is Back⚫🎗☯t].")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "╚☆🎗Rango🎗☆╗\n╚🎗Kicker🎗╮╗".format(str(elapsed_time)))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"Promoted admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"Promoted staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"Promoted bot")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"Removed From List admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"Succesed di Refresh...")
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ...
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "「 Succesed Changed 」\nPesan Msg Changed To :\n\n{}".format(str(spl)))
